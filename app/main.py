...
from . import accounts, ai, auth, backup, config, csp_nonce, csrf, faq, ip_allowlist, metrics
...
# CSP nonce — HTML 응답의 인라인 스크립트에 nonce 자동 주입.
# SecurityHeaders 다음에 add → CSP 헤더가 이미 설정된 뒤 nonce 로 교체.
app.add_middleware(csp_nonce.CspNonceMiddleware)
