...
{"summary": "<상담 내용 2~3문장 요약>", "category": "<배송|환불/교환|결제|회원/계정|제품|계정/접속|네트워크|이메일|소프트웨어|권한/보안|하드웨어|데이터|자동차검사|운수자격|운행기록·리콜|교통안전|TS 누리집|기타 중 하나>", "tags": ["<태그>", ...], "key_points": ["<핵심 사항>", ...]}
